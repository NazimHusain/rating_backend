...
from apps.recipes.task import  reduce_recipe_image_size
...
def trigger_image_resize(sender, instance, created, **kwargs):
    if created and instance.image:
        reduce_recipe_image_size(instance.image.name)
